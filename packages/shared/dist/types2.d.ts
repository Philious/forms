...
export type Settings<T extends EntryTypeEnum> = T extends 'barometer' ? BarometerSettings : T extends EntryTypeEnum.Text ? TextSettings : T extends EntryTypeEnum.Number ? NumberSettings : T extends EntryTypeEnum.Number ? DateSettings : T extends EntryTypeEnum.Textarea ? TextAreaSettings : T extends EntryTypeEnum.Selector ? SelectorSettings : T extends EntryTypeEnum.Checkbox ? CheckSettings : T extends EntryTypeEnum.CheckboxGroup ? CheckGroupSettings : T extends EntryTypeEnum.RadioGroup ? RadioGroupSettings : TextStringSettings;
