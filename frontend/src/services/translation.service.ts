...
import { Entrey } from '../app/pages/questions/types';
...
import { allKeys, buildTree, toTranslationFormGroup, transformAll, translationSetFormGroup } from '../helpers/translation.utils';
import {
...
export class TranslationService {
  ...
  openTranslation(id: string) {
    this._openTranslations().add(id);
  }
  removeTranslation(id: string) {
    this._openTranslations().delete(id);
  }
